...
import bgAboutImageI from "../assets/images/leaf-aw.jpg"
import bgAboutImageIi from "../assets/images/autumn-aw.jpg"
    ...
    return (
        <>
            ...
            <section
                ...
                style={{ backgroundImage: `url(${bgAboutImageI})`, backgroundSize: 'cover', }}>
                <h1 className="text-4xl text-[#9C88FF] font-bold">About Us</h1>
            </section>
