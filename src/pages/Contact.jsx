...
export default function Contact() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await fetch("https://formspree.io/f/movnpnde", {
				method: "POST",
				body: formData,
				headers: {
			...
			<div className="bg-white text-gray-800">
				...
				<section data-aos="fade-right" className="py-16 px-6 max-w-6xl mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3">
					...
					<div className="bg-[#FAF9FF] rounded-xl p-6 shadow transform hover:scale-105 transition duration-300">
						...
						<a href="mailto:pkanzonicosmetics@yahoo.com" className="hover:text-[#9C88FF] transition">pkanzonicosmetics@yahoo.com</a>
					</div>
